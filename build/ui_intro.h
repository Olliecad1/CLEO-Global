...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/icons/denarius128")));
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Denarius!", Q_NULLPTR));
        label_4->setText(QApplication::translate("Intro", "This is the first time <strong>Denarius</strong> has launched on this computer, so you can choose where Denarius will store its data.", Q_NULLPTR));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Denarius will download and store a copy of the Denarius block chain. At least <strong>%1GB</strong> of data will need to be available to be stored in this directory, as it will grow over time. The wallet data will also be stored in this directory.", Q_NULLPTR));
