...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        label_81 = new QLabel(tab_info);
        label_81->setObjectName(QStringLiteral("label_81"));

        gridLayout->addWidget(label_81, 9, 0, 1, 1);
        ...
        isNativeTor = new QCheckBox(tab_info);
        isNativeTor->setObjectName(QStringLiteral("isNativeTor"));
        isNativeTor->setEnabled(false);

        gridLayout->addWidget(isNativeTor, 9, 1, 1, 1);
        ...
        peerId->setObjectName(QStringLiteral("peerId"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Denarius - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "Denarius Core", Q_NULLPTR));
        ...
        label_8->setText(QApplication::translate("RPCConsole", "Testnet On/Off", Q_NULLPTR));
        label_81->setText(QApplication::translate("RPCConsole", "Native Tor On/Off", Q_NULLPTR));
        isTestNet->setText(QString());
        isNativeTor->setText(QString());
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Denarius debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Denarius-Qt help message to get a list with possible Denarius command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label_23->setText(QApplication::translate("RPCConsole", "Peer ID", Q_NULLPTR));
        peerId->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_30->setText(QApplication::translate("RPCConsole", "Direction", Q_NULLPTR));
        ...
        label_41->setText(QApplication::translate("RPCConsole", "Services", Q_NULLPTR));
