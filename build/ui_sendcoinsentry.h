...
#endif // QT_NO_TOOLTIP
        label1->setText(QApplication::translate("SendCoinsEntry", "N&arration:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        narration->setToolTip(QApplication::translate("SendCoinsEntry", "Enter a short note to send with payment (max 24 characters)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("SendCoinsEntry", "&Label:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. DyvGBZBowrppUwwNUo1GCRDTibzJi7g2M)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
