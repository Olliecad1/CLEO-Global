...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 D"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 D"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 D"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 D"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 10, 781, 25));
        horizontalLayoutPanel = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayoutPanel->setSpacing(25);
