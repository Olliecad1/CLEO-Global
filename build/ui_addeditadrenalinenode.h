...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit Denarius Masternode", Q_NULLPTR));
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter an Alias (friendly name) for your <span style=\" font-weight:600;\">Denarius Masternode</span> and its address (either a clearnet IP and port or Tor onion address and port).</p><p>The address should be in the format <span style=\" font-style:italic;\">155.456.789.123:19999</span> or <span style=\" font-style:italic;\">akjdsafxjkhasdf.onion:19999</span>. </p><p>You must send exactly <span style=\" font-weight:600; text-decoration: underline;\">5000 D</span> to the collateral address.</p></body></html>", Q_NULLPTR));
        ...
        AddEditAddressPasteButton->setToolTip(QApplication::translate("AddEditAdrenalineNode", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        AddEditAddressPasteButton->setText(QString());
        AddEditAddressPasteButton->setShortcut(QApplication::translate("AddEditAdrenalineNode", "Alt+P", Q_NULLPTR));
        label_5->setText(QApplication::translate("AddEditAdrenalineNode", "PrivKey*", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        AddEditPrivkeyPasteButton->setToolTip(QApplication::translate("AddEditAdrenalineNode", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        AddEditPrivkeyPasteButton->setText(QString());
        AddEditPrivkeyPasteButton->setShortcut(QApplication::translate("AddEditAdrenalineNode", "Alt+P", Q_NULLPTR));
        label_2->setText(QApplication::translate("AddEditAdrenalineNode", "TxHash*", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        AddEditTxhashPasteButton->setToolTip(QApplication::translate("AddEditAdrenalineNode", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        AddEditTxhashPasteButton->setText(QString());
        AddEditTxhashPasteButton->setShortcut(QApplication::translate("AddEditAdrenalineNode", "Alt+P", Q_NULLPTR));
