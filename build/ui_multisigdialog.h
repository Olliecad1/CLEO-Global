...
public:
    ...
    void setupUi(QWidget *MultisigDialog)
    {
        ...
        maxSignaturesLabel->setText(QStringLiteral("/ 1"));
        ...
        saveRedeemScriptButton->setObjectName(QStringLiteral("saveRedeemScriptButton"));

        horizontalLayout_15->addWidget(saveRedeemScriptButton);

        saveMultisigAddressButton = new QPushButton(tabCreateAddress);
        saveMultisigAddressButton->setObjectName(QStringLiteral("saveMultisigAddressButton"));
        ...
        inputsAmount->setText(QStringLiteral("123.456"));
        ...
        label->setText(QStringLiteral("<strong>D</strong>"));
        ...
        outputsAmount->setText(QStringLiteral("123.456"));
        ...
        label_2->setText(QStringLiteral("<strong>D</strong>"));
        ...
        fee->setText(QStringLiteral("123.456"));

        horizontalLayout_16->addWidget(fee);

        label_3 = new QLabel(outputsBox);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setText(QStringLiteral("<strong>D</strong>"));
    ...
    void retranslateUi(QWidget *MultisigDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        saveRedeemScriptButton->setToolTip(QApplication::translate("MultisigDialog", "The redeem script will be required to spend the funds sent to the multisig address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        saveRedeemScriptButton->setText(QApplication::translate("MultisigDialog", "Save redeem script", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        saveMultisigAddressButton->setToolTip(QApplication::translate("MultisigDialog", "Add the multisig address to your personal addresses", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        saveMultisigAddressButton->setText(QApplication::translate("MultisigDialog", "Add address to wallet", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        pasteTransactionButton->setToolTip(QApplication::translate("MultisigDialog", "Paste transaction from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
