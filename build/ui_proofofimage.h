...
public:
    ...
    void setupUi(QWidget *ProofOfImage)
    {
        ...
        ProofOfImage->resize(563, 382);
        ProofOfImage->setMinimumSize(QSize(0, 0));
        ...
        label_6 = new QLabel(Proof);
        label_6->setObjectName(QStringLiteral("label_6"));

        verticalLayout_2->addWidget(label_6);

        edit = new QLineEdit(Proof);
        ...
        createPushButton->setMinimumSize(QSize(250, 50));
    ...
    {
        ProofOfImage->setWindowTitle(QApplication::translate("ProofOfImage", "Form", Q_NULLPTR));
        Proof->setTitle(QApplication::translate("ProofOfImage", "Proof of Data", Q_NULLPTR));
        labelFile->setText(QApplication::translate("ProofOfImage", "Select a file location", Q_NULLPTR));
        filePushButton->setText(QApplication::translate("ProofOfImage", "Select File", Q_NULLPTR));
        label_6->setText(QApplication::translate("ProofOfImage", "Enter up to a 24 character narration to store in the chain:", Q_NULLPTR));
        createPushButton->setText(QApplication::translate("ProofOfImage", "Create Timestamp (Pay 0.001 D) Proof of Data*", Q_NULLPTR));
        label_2->setText(QApplication::translate("ProofOfImage", "<html><head/><body><p><span style=\" font-style:italic; color:#ff0000;\">*Warning:</span> This sends <span style=\" font-weight:600;\">0.001 D</span> to a new address generated by hashing the image or data file selected. The address can be checked on a Denarius block explorer for a proof of creation date timestamp.</p></body></html>", Q_NULLPTR));
        label->setText(QApplication::translate("ProofOfImage", "Generated Timestamp Denarius Address:", Q_NULLPTR));
        label_4->setText(QApplication::translate("ProofOfImage", "Transaction Hash:", Q_NULLPTR));
        checkTxButton->setText(QApplication::translate("ProofOfImage", "Check Transaction", Q_NULLPTR));
        label_5->setText(QApplication::translate("ProofOfImage", "Check a previous Transaction Hash for Denarius proofs.", Q_NULLPTR));
        checkButton->setText(QApplication::translate("ProofOfImage", "Check Timestamp", Q_NULLPTR));
        label_3->setText(QApplication::translate("ProofOfImage", "<html><head/><body><p>Check a timestamp by checking when the address was first seen on a block explorer.</p></body></html>", Q_NULLPTR));
    } // retranslateUi
