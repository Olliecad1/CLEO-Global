...
{
    resize(600, 400);
    setWindowTitle(tr("Cleo") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/cleo"));
    setWindowIcon(QIcon(":icons/cleo"));
#else
...
void BitcoinGUI::createActions()
{
	...
	statisticsAction->setStatusTip(tr("Cleo Statistics"));
    tabGroup->addAction(statisticsAction);

	blockAction = new QAction(QIcon(":/icons/block"), tr("&Block Explorer"), this);
    blockAction->setToolTip(tr("Explore the Cleo Blockchain"));
	...
	marketAction->setStatusTip(tr("Cleo Market Data"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Cleo address"));
    sendCoinsAction->setCheckable(true);
	sendCoinsAction->setStatusTip(tr("Send Cleo"));
	...
	receiveCoinsAction->setStatusTip(tr("Receive Cleo"));
    ...
    fortunastakeManagerAction->setToolTip(tr("Show Cleo Fortuna Stakes status and configure your nodes."));
    ...
    proofOfImageAction ->setToolTip(tr("Timestamp Files on the Cleo blockchain."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Cleo"), this);
    aboutAction->setToolTip(tr("Show information about Cleo"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Cleo"));
    ...
    openPeerAction->setStatusTip(tr("Show Cleo network peers"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cleo client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cleo client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cleo network", "", count));
    ...
    if(fNativeTor)
    {
        ...
        labelConnectTypeIcon->setToolTip(tr("Not Connected via the Tor Network, Start Cleo with the flag nativetor=1"));
    }
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    {
        progressBarLabel->setText(tr("Connecting to the Cleo network..."));
...
void BitcoinGUI::showConfEditor()
{
    ...
    /* Open cleo.conf with the associated application */
    if (boost::filesystem::exists(pathConfig)) {
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(pathConfig.string())));
	} else {
		QMessageBox::warning(this, tr("No cleo.conf"),
        tr("Your cleo.conf does not exist! Please create one in your Cleo data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your fortunastake.conf does not exist! Please create one in your Cleo data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cleo address or malformed URI parameters."));
    }
