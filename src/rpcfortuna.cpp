...
Value fortunastake(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
		...
		throw runtime_error(
			...
			"  start        - Start fortunastake configured in cleo.conf\n"
			...
			"  stop         - Stop fortunastake configured in cleo.conf\n"
			...
			//"  vote-many    - Vote on a Cleo initiative\n"
			//"  vote         - Vote on a Cleo initiative\n"
            );
    if (strCommand == "stop")
    {
